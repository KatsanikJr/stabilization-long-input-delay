...
%
% Implements equations (1) and (3)–(9) of the paper for the switched system
% when the ACTUAL input delay is:
%
%          D_actual = 1.05
%
% but the controller still assumes:
%
%          D_controller = 1.
%
% This tests robustness of controller U1 to delay
% perturbations (Section 4.3 of the paper).
%
% Output:
%   - Plots X(t), U(t), and switching signal sigma(t).
%
% Required files:
%   - computeK.m, optimizeL2.m, swsig_values.mat   (in ../Auxiliary Functions/)
%
...
Dcontroller = 1;             % Input Delay that controller takes into account different than the actual delay  
