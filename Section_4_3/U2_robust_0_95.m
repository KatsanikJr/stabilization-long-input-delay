%% U2_robust_0_95.m
% Averaging exact predictors- controller U2 with dwell-time knowledge.
%
...
%          D_controller = 1.
%
% This tests robustness of controller U2 to delay
...
%
% Required files:
%   - computeK.m, swsig_values.mat   (in ../Auxiliary Functions/)
%
...
Dcontroller = 1;             % Input Delay that controller takes into account (in this case it is the same)
